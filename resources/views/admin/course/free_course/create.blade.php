...
@section('title', 'Create Free Video | ')
@section('content')
    <section class="section dashboard">
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Add New Free Video</h5>
                        <form action="{{ route('free-courses.store') }}" method="POST" enctype="multipart/form-data">
                            @method('POST')
                            @csrf
                            ...
                            <div class="row mb-3">
                                <div class="col-sm-12">
                                    ...
                                    <a href="{{ route('free-courses.index') }}" class="btn btn-sm btn-danger float-end m-2">Cancel</a>
                                </div>
                            </div>
