...
<section class="section dashboard">
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title">{{$service->title}} Apply Request</h5>
                    @if (Session::has('msg'))
                        <p id="flash-message" class="alert alert-info">{{ Session::get('msg') }}</p>
                    @endif
                    {{-- <a class="btn btn-sm btn-outline-success float-end" href="{{ route('services.create') }}">Add Course</a> --}}
                            ...
                            <tr>
                                ...
                                <td>
                                    <button class="btn btn-info btn-sm view-booking" 
                                            data-id="{{ $booking->id }}" 
                                            data-service="{{ $booking->course->title }}"
        ...
        data-id="{{ $booking->id }}" 
        data-url="{{ route('course.destroy', $booking->id) }}">
    Delete
</button>
                                </td>
                            </tr>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p><strong>Course:</strong> <span id="viewService"></span></p>
