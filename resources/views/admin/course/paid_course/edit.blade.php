                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('paid-courses.update', $course->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <textarea name="overview" class="form-control" rows="4">{{ old('overview', $course->overview) }}</textarea>
                                    @error('overview')
                                        <span class="text-danger" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <textarea name="curriculum" class="form-control" rows="4">{{ old('curriculum', $course->curriculum) }}</textarea>
                                    @error('curriculum')
                                        <span class="text-danger" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <textarea name="instructor" class="form-control" rows="4">{{ old('instructor', $course->instructor) }}</textarea>
                                    @error('instructor')
                                        <span class="text-danger" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
